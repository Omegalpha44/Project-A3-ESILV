...
namespace Solution
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //Salarie s0 = new Salarie(0, "Pat
            //ck", "Jean", new DateTime(1956, 5, 5), "0", "0", 0, new DateTime(10, 10, 10), "PDG", 0);
            ...
            AffichageGraphique graphique = new AffichageGraphique(@"employee.csv",@"client.csv",MainManager); // on créé un afficheur graphique vide, contenant le path vers le fichier txt pour les employées et le manager à modifier
